...
If starting from a fresh OS image, I recommend using the provided RPI imager (https://www.raspberrypi.com/software/). ![RPI OS Imager](images/RPIImager.png) ![RPI OS Version+git add *](images/RPIVersion.png)
